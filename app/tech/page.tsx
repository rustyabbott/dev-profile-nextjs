  ...
  return (
    <>
      ...
      <main className="pageWrapper">
        ...
        <h2>REP Fitness (<Link href="https://www.repfitness.com" target="_blank" rel="noopener noreferrer">eCommerce Site</Link>)</h2>
        <div className="gif-wrapper">
        ...
        <h2>InMotion Hosting (<Link href="https://www.inmotionhosting.com" target="_blank" rel="noopener noreferrer">Marketing Site</Link>)</h2>
        <div className="gif-wrapper">
        ...
        <h2>RustyAbbott.com (<Link href="https://github.com/rustyabbott/rustyabbott.com" target="_blank" rel="noopener noreferrer">GitHub</Link>)</h2>
        <p>The web app you&apos;re currently viewing was built with Facebook&apos;s <Link href="https://github.com/facebook/create-react-app" target="_blank" rel="noopener noreferrer">Create React App</Link>. It utilizes hookrouter for routing and SASS/SCSS for styling.</p>
        <h2>Memory Game (<Link href="https://github.com/rustyabbott/memory-game" target="_blank" rel="noopener noreferrer">GitHub</Link>, <Link href="https://rustyabbott.github.io/memory-game/" target="_blank" rel="noopener noreferrer">Play Live</Link>)</h2>
        ...
        <h2>Arcade Game (<Link href="https://github.com/rustyabbott/arcade-game" target="_blank" rel="noopener noreferrer">GitHub</Link>, <Link href="https://rustyabbott.github.io/arcade-game/" target="_blank" rel="noopener noreferrer">Play Live</Link>)</h2>
        ...
        <h2>Analog Clock (<Link href="https://github.com/rustyabbott/clock" target="_blank" rel="noopener noreferrer">GitHub</Link>, <Link href="https://rustyabbott.github.io/clock/" target="_blank" rel="noopener noreferrer">Play Live</Link>)</h2>
